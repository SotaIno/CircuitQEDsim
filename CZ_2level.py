...
Q1=Tunabletransmon(EC=Ec1, EJmax=Ej1,Nq=2)
Q2=Tunabletransmon(EC=Ec2, EJmax=Ej2,Nq=2)
QQ=QQ(Q1,Q2,g)

#ini_state=iniState2Qsys(Q1.Nq,Q2.Nq,1,1)
Nq=2

ini_coeff = [0,1e-9,1e-9,1] # 11
ini_state = ini_coeff[0]*qt.tensor(ket(Nq,0), ket(Nq,0)) \
            + ini_coeff[1]*qt.tensor(ket(Nq,0), ket(Nq,1)) \
            + ini_coeff[2]*qt.tensor(ket(Nq,1), ket(Nq,0)) \
            + ini_coeff[3]*qt.tensor(ket(Nq,1), ket(Nq,1)) 
